...
# === Orden de percentiles personalizado ===
...
# === Añadir nueva columna: diferencia relativa de beneficio (%) entre RF y MILP (tRF) ===
...
# === Figuras combinadas por percentil ===
width = 0.25
offset = width / 2
for pct in orden_percentiles:
    subset = df[df["percentile"] == pct].sort_values("dams")
    ...
    # === Combinar leyendas en primer subplot
